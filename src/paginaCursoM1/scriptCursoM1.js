...
//Verifica se curso foi concluido pelo usuario
var cursoM1 = false
if (localStorage.getItem("cursoM1") == "true") {
    cursoM1 = true;
...
function concluir() {
    ...
    localStorage.setItem("cursoM1", true);
    ...
    if (cursoRealizado == null) {
        ...
        var curso1 = document.getElementById('titulo1').innerHTML;
        var curso2;
